            ...
            <div className="p-6 pb-4 text-center bg-gradient-to-br from-gray-50 to-white">
                <div className="relative mx-auto mb-4 w-20 h-20 sm:w-24 sm:h-24">
                    {executive.image && !imageError ? (
                        ...
                        <div
                            className={`w-full h-full rounded-full bg-gradient-to-br ${getGradientColor(executive.id)} flex items-center justify-center text-white font-bold text-lg sm:text-xl shadow-lg border-4 border-white`}
                        >
